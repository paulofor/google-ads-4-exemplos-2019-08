...
public class AddCampaignsTst {
	...
	public static void main(String[] args) {
		...
		try {
			new AddCampaignsTst().runExample(googleAdsClient, params.customerId);
	...
	private static String addCampaignBudget(GoogleAdsClient googleAdsClient, long customerId) {
		CampaignBudget budget = CampaignBudget.newBuilder()
				...
				.setDeliveryMethod(BudgetDeliveryMethod.STANDARD).setAmountMicros(Int64Value.of(500_000)).build();
	...
	private void runExample(GoogleAdsClient googleAdsClient, long customerId) {
		...
		String sbudgetResourceName = addCampaignBudget(googleAdsClient, customerId);
		...
		Campaign campaign = Campaign.newBuilder()
				.setName(StringValue.of("Campanha de Teste #" + System.currentTimeMillis()))
				...
				// .setManualCpc(ManualCpc.newBuilder().build()).setCampaignBudget(StringValue.of(budgetResourceName))
