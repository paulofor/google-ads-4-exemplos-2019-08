...
public class AddCampaignsGeralTst {
  ...
  public static void main(String[] args) {
    ...
    try {
      new AddCampaignsGeralTst().runExample(googleAdsClient, params.customerId);
  ...
  private void runExample(GoogleAdsClient googleAdsClient, long customerId) {
    ...
    for (int i = 0; i < NUMBER_OF_CAMPAIGNS_TO_ADD; i++) {
      ...
      Campaign campaign =
          Campaign.newBuilder()
              .setName(StringValue.of("Deus nos ajude #" + System.currentTimeMillis()))
